...
public class MenegerController {
    ...
    public ResponseEntity<?> getemployeCenterBranchesId(@RequestParam(defaultValue = "0") int page,@RequestParam(defaultValue = "0") int size,@PathVariable("centerBranchesId") Long id) {

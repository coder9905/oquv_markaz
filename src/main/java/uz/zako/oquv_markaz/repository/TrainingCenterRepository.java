...
public interface TrainingCenterRepository extends JpaRepository<TrainingCenter, Long> {
    ...
    @Query("select new uz.zako.oquv_markaz.payload.TrainingCenterPayload(tc.id,tc.name,tc.block,tc.workingTime,tc.createdAt,tc.updatedAt) from TrainingCenter tc")
